...
class ResNetSE(tf.keras.models.Model):
    def __init__(self, **kwargs):
        super(ResNetSE, self).__init__(**kwargs)
...
class ResNetSEM1(tf.keras.models.Model):
    def __init__(self, **kwargs):
        super(ResNetSEM1, self).__init__(**kwargs)
...
class ResNetSEM3(tf.keras.models.Model):
    def __init__(self, **kwargs):
        super(ResNetSEM3, self).__init__(**kwargs)

        self.conv0 = Conv2D(16, (3, 3), strides=(1, 1), name='conv0', padding='same', use_bias=False, kernel_initializer='he_normal')
        self.block_collector = []
        block_num = 8, 8, 8
        filters_num = 16, 32, 64
        for i in range(1, 4):
